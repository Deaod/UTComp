...
DefaultProperties
{
    FireModeClass(0)=class'UTCompv18.NewNet_MiniGunFire'
    FireModeClass(1)=class'UTCompv18.NewNet_MiniGunAltFire'
    PickupClass=Class'UTCompv18.NewNet_MiniGunPickup'
}
