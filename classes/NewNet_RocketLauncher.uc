...
DefaultProperties
{
    PickupClass=Class'UTCompv18.NewNet_RocketLauncherPickup'
    FireModeClass(0)=class'UTCompv18.NewNet_RocketFire'
    FireModeClass(1)=class'UTCompv18.NewNet_RocketMultiFire'
}
