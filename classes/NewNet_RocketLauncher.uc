...
DefaultProperties
{
    PickupClass=Class'UTCompv18a.NewNet_RocketLauncherPickup'
    FireModeClass(0)=class'UTCompv18a.NewNet_RocketFire'
    FireModeClass(1)=class'UTCompv18a.NewNet_RocketMultiFire'
}
